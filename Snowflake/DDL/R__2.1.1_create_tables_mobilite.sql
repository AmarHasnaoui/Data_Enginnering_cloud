...
ALTER TABLE RAW_TRAFIC_VELO ALTER COLUMN lien_photo_site SET DATA TYPE VARCHAR(16777216);
ALTER TABLE RAW_TRAFIC_VELO ALTER COLUMN photos SET DATA TYPE VARCHAR(16777216);
ALTER TABLE RAW_TRAFIC_VELO ALTER COLUMN test_lien_vers_photo SET DATA TYPE VARCHAR(16777216);
ALTER TABLE RAW_TRAFIC_VELO ALTER COLUMN url_sites SET DATA TYPE VARCHAR(16777216);
